...
def mb_new(db: Session, qmb: schemas.MB):
    ...
    mb.sname         = qmb.sname        
    mb.mid           = qmb.mid          
    mb.loadtype      = qmb.loadtype     
    mb.diameter      = qmb.diameter     
    mb.slen          = qmb.slen         
    mb.load_speed    = qmb.load_speed   
    mb.strain_rate   = qmb.strain_rate  
    mb.uts           = qmb.uts          
    mb.mb_yield      = qmb.mb_yield     
    mb.area_red      = qmb.area_red     
    mb.elongation    = qmb.elongation   
    mb.strength_co_k = qmb.strength_co_k
    mb.harden_n      = qmb.harden_n     
    mb.modul         = qmb.modul        
